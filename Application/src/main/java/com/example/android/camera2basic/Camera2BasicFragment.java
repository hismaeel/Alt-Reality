...
public class Camera2BasicFragment extends Fragment
    ...
    private ScriptC_covnert mScript;

    private RenderScript rs;

    private Allocation mReceive;
    ...
    private void create() {
        ...
        Type.Builder yuvType = new Type.Builder(rs, Element.YUV(rs)).setX(mPreviewSize.getWidth()).setY(mPreviewSize.getHeight());
        yuvType.setYuvFormat(ImageFormat.YUV_420_888);
        mReceive = Allocation.createTyped(rs, yuvType.create(), Allocation.USAGE_IO_INPUT | Allocation.USAGE_SCRIPT);
...
//                int orientation = getResources().getConfiguration().orientation;
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            mPreviewRequestBuilder.addTarget(mReceive.getSurface());

            // Here, we create a CameraCaptureSession for camera preview.
            mCameraDevice.createCaptureSession(Arrays.asList(mReceive.getSurface()),
